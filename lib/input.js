    ...
    validate: (youtubeChannelID, { youtubeAPIKey }) => {
      ...
      return YOUTUBE_API.verifyYoutubeChannelID(youtubeChannelID, updatedAPIKey)
        .then(res => {
          ...
          prefs.youtube = { channelID: youtubeChannelID };
          return true;
        })
        .catch(error => {
          console.log('somehow error');
          return YOUTUBE.invalidChannelID;
        });
    },
  },
    ...
    switch (activity) {
      ...
      case ACTIVITIES.WATCH_YOUTUBE:
        ...
        if (!youtubeUseAPIKey || !youtubeUseChannelID || !prefs.youtube || !prefs.youtube.apiKey) {
          let updatedFields = {};
          updatedFields.apiKey = !youtubeUseAPIKey ? youtubeAPIKey : prefs.youtube.apiKey;
          updatedFields.channelID = !youtubeUseChannelID ? youtubeChannelID : prefs.youtube.channelID;
